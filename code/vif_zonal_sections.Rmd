...
Version_IDs <- c(Version_IDs_1, Version_IDs_2, "v_102", "v_202")
...
dcant_zonal_bias_all_corr <- dcant_zonal_bias_all %>%
  select(lat, depth, basin_AIP, dcant_bias, vif_max, period) %>% 
