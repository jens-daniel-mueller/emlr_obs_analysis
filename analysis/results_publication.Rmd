...
```{r write_dcant_column_inventory_files_for_submission, eval=FALSE}
...
```{r write_dcant_column_inventory_uncertainty_files_for_submission, eval=FALSE}
...
p_dcant_profiles <-
  ...
  labs(y = "Depth (m)",
       x = dcant_umol_label) +
  facet_wrap(~ basin, ncol = 3, dir = "v") +
  theme(legend.position = c(0.91, 0.13),
...
```{r write_ocean_interior_dcant, eval=FALSE}
