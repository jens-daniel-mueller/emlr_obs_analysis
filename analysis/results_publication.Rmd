...
dcant_pgc_label <- expression(Delta * C["ant"]~inventory~(PgC))
...
dcant_layer_budget_label <- 
  expression(Delta ~ C[ant] ~ "inventory per 500m depth layer (PgC)")
...
```{r dcant_inventory_additive_uncertainty_incl_two_decades, eval=FALSE}

dcant_budget_basin_MLR_all_uncertainty_two_decades <-
  dcant_budget_basin_MLR_all_ensemble %>%
  filter(data_source != "mod_truth") %>%
  select(-c(inv_depth, Version_ID, tref1))

dcant_budget_basin_MLR_all_uncertainty_two_decades <- additive_uncertainty(dcant_budget_basin_MLR_all_uncertainty_two_decades)

delta_dcant_budget_basin_MLR_all_uncertainty_two_decades <- dcant_budget_basin_MLR_all_uncertainty_two_decades[[3]]
dcant_budget_basin_MLR_all_uncertainty_contributions_two_decades <- dcant_budget_basin_MLR_all_uncertainty_two_decades[[2]]
dcant_budget_basin_MLR_all_uncertainty_two_decades <- dcant_budget_basin_MLR_all_uncertainty_two_decades[[1]]
