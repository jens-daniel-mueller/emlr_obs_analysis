...
dcant_budget_lat_grid_uncertainty %>%
  ...
  scale_y_continuous(limits = c(-78,65),
                     ...
                     expand = c(0,0),
                     position = "right") +
  scale_x_continuous(limits = c(-0.1,2.5), breaks = seq(0, 3, 1),
                     expand = c(0,0),
                     position = "top") +
  scale_fill_manual(values = fill_scale) +
  scale_color_manual(values = fill_scale) +
  labs(x = expression(atop(Delta*Delta*C[ant]~inventory,
                           (Pg~C~dec^{-1}~"5°lat"^{-1})))) +
  theme_classic() +
...
delta_dcant_budget_lat_grid_uncertainty %>%
  ...
  scale_y_continuous(limits = c(-78,65),
                     ...
                     expand = c(0,0),
                     position = "right") +
  scale_x_continuous(limits = c(-0.65,0.65), breaks = seq(-0.6, 0.6, 0.3),
                     expand = c(0,0)) +
  labs(x = expression(atop(Delta*Delta*C[ant]~inventory,
                           (Pg~C~dec^{-1}~"5°lat"^{-1})))) +
  theme_classic() +
