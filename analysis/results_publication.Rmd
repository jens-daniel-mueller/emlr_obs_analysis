...
df_regional <-
  ...
  select(-c(MLR_basins_reference, MLR_basins, dcant))
...
```{r column_inventory_additive_uncertainty_x}
...
dcant_inv_sensitivity_contributions %>%
  ...
  p_map_cant_inv(var = "sd",
                 ...
                 title_text = NULL) +
  facet_nested(Version_ID_group ~ data_source + period) +
  theme(axis.text = element_blank(),
        axis.ticks = element_blank())
...
```{r column_inventory_additive_uncertainty}
...
```{r inventory_maps_absolute_mod_x, fig.asp=1.2}
