...
```{r read_RECCAP2_flux_products}

RECCAP2_fgco2_glob_all_annual <-
...
RECCAP2_fgco2_glob_all_annual_cum_1994 <- RECCAP2_fgco2_glob_all_annual %>%
...
tcant_ts %>% 
  ggplot(aes(pCO2, tcant)) +
  geom_ribbon(aes(ymin = tcant - tcant_sd, ymax = tcant + tcant_sd), fill = "grey50",
              alpha = 0.2) +
  geom_line(data = RECCAP2_fgco2_glob_all_annual_cum_1994,
            aes(pCO2, fgco2_glob_corr_cum, group = product, col="Surface flux products")) +
