...
```{r concentration_profiles, fig.asp=1.2}
...
```{r concentration_profiles_MLR_basins, fig.asp=1.5}
...
```{r concentration_profiles_basin_AIP_offset, fig.asp=1.2}
...
```{r concentration_profiles_MLR_basins_offset, fig.asp=1.5}
...
```{r depth_layer_budget_basin_MLR, fig.asp=1.5}
...
```{r depth_layer_budget_basin_MLR_cumulative, fig.asp=1.5}
