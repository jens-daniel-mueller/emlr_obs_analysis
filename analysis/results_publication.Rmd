...
beta_inv_label <- expression(Mean~beta~column~inventory~(mol~m^{-2}~ppm^{-1}))
...
dcant_budget_lat_grid_uncertainty %>%
  ...
  scale_y_continuous(limits = c(-78,65), breaks = seq(-80, 80, 20),
                     expand = c(0,0)) +
  scale_x_continuous(limits = c(0,2.5), breaks = seq(0, 3, 1),
                     expand = c(0,0)) +
  scale_fill_manual(values = fill_scale) +
  scale_color_manual(values = fill_scale) +
  labs(y = "Latitude (°N)",
       x = expression(atop(Delta*C[ant]~inventory~per~"5°"~latitude~bin,
                           (Pg~C~dec^{-1})))) +
  theme_classic() +
  theme(legend.title = element_blank(),
        legend.position = "bottom",
...
dcant_budget_lat_grid_uncertainty %>%
  ...
  scale_color_manual(values = fill_scale) +
  labs(y = "Latitude (°N)",
       x = expression(atop(Delta*C[ant]~inventory,
                           (Pg~C~dec^{-1}~"5°lat"^{-1})))) +
  theme_classic() +
  theme(legend.title = element_blank(),
        legend.position = "bottom")
...
delta_dcant_budget_lat_grid_uncertainty %>%
  ...
  scale_x_continuous(limits = c(-0.6,0.6), breaks = seq(-0.6, 0.6, 0.3),
                     expand = c(0,0)) +
  labs(y = "Latitude (°N)",
       x = expression(atop(Delta*Delta*C[ant]~inventory,
                           (Pg~C~dec^{-1}~"5°lat"^{-1})))) +
  theme_classic() +
  theme(legend.title = element_blank(),
        legend.position = "bottom")
