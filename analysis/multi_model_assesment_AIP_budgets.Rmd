...
dcant_budget_global_all_dissic %>%
  ...
  ggplot(aes(inv_depth, value, col = {{config}})) +
...
dcant_budget_global_bias_all_decomposition %>%
  filter(estimate == "dcant") %>% 
  select(inv_depth, dcant_bias, contribution, {{config}}, period) %>%
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(`dcant offset`, `delta C* - mod_truth`, col = {{config}})) +
...
dcant_budget_global_bias_all_decomposition %>%
  ...
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(`dcant offset`, `C* prediction error`, col = {{config}})) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  geom_point() +
  coord_fixed() +
...
dcant_budget_global_bias_all_decomposition %>%
  ...
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(`dcant offset`, `C* prediction error` + `delta C* - mod_truth`, col = {{config}})) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  geom_point() +
  coord_fixed() +
...
dcant_budget_global_bias_all_decomposition %>%
  ...
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(`dcant offset`, `C* drift`, col = {{config}})) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  geom_point() +
  coord_fixed() +
...
dcant_budget_global_bias_all_decomposition %>%
  ...
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(`dcant offset` - `C* drift`, `C* prediction error`, col = {{config}})) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  geom_point() +
  coord_fixed() +
...
dcant_budget_global_bias_all_decomposition %>%
  ...
  pivot_wider(names_from = contribution,
              values_from = dcant_bias) %>%
  ggplot(aes(x = period, col = {{config}})) +
  geom_hline(yintercept = 0) +
