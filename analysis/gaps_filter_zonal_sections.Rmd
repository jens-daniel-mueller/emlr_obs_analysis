...
dcant_zonal_bias_all_corr <- dcant_zonal_bias_all %>%
  select(lat, depth, basin_AIP, dcant_bias, gap_filling, period) %>% 
...
dcant_zonal_bias_all_corr %>% 
  ...
  geom_bin2d() +
  facet_grid(basin_AIP ~ gap_filling) +
...
```{r ensemble_sd, fig.asp=0.9, eval=FALSE}
...
```{r ensemble_sd_vs_bias, fig.asp=0.5, eval=FALSE}
