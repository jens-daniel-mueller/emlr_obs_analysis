...
p_lon_94 <- dcant_lon_grid_ensemble %>%
  ...
  scale_x_continuous(name = "Longitude (°E)", limits = c(20,380), expand = c(0,0)) +
...
p_lon_94 + plot_spacer() + p_map_94 + p_lat_94 + 
  p_map_04 + p_lat_04 + p_lon_04 + plot_spacer() +
  plot_layout(ncol = 2,
              guides = "collect",
              heights = c(1,2,2,1),
              widths = c(3,1)) &
